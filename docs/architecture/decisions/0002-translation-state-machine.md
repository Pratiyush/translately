...
- Entity source: [`Translation.kt`](https://github.com/Pratiyush/translately/blob/master/backend/data/src/main/kotlin/io/translately/data/entity/Translation.kt)
- [ADR index](README.md)
